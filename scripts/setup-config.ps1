# Open Agent Configuration Setup Script for Windows
# This script helps you set up Open Agent configuration files
...
$CONFIG_DIR = Join-Path $env:USERPROFILE ".open-agent\config"

Write-ColorOutput "==================================================" -Color "Cyan"
Write-ColorOutput "   Open Agent Configuration Setup" -Color "Cyan"
Write-ColorOutput "==================================================" -Color "Cyan"
Write-Host ""
...
if (Test-Path $CONFIG_DIR) {
    ...
    $BACKUP_DIR = Join-Path $env:USERPROFILE ".open-agent\config.backup.$timestamp"
...
$FILES_COPIED = 0
$GITHUB_RAW_URL = "https://raw.githubusercontent.com/MiniMax-AI/open-agent/main/open_agent/config"
...
Write-Host ""
Write-ColorOutput "1. Install Open Agent:" -Color "Yellow"
Write-ColorOutput "   pipx install git+https://github.com/MiniMax-AI/open-agent.git" -Color "Green"
Write-Host ""
...
Write-Host ""
Write-ColorOutput "3. Start using Open Agent:" -Color "Yellow"
Write-ColorOutput "   open-agent                              # Use current directory" -Color "Green"
Write-ColorOutput "   open-agent --workspace C:\path\to\project # Specify workspace" -Color "Green"
Write-ColorOutput "   open-agent --help                      # Show help" -Color "Green"
Write-Host ""

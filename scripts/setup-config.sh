#!/bin/bash
# Open Agent Configuration Setup Script
...
CONFIG_DIR="$HOME/.open-agent/config"

echo -e "${CYAN}╔════════════════════════════════════════════════╗${NC}"
echo -e "${CYAN}║   Open Agent Configuration Setup              ║${NC}"
echo -e "${CYAN}╚════════════════════════════════════════════════╝${NC}"
echo ""
...
if [ -d "$CONFIG_DIR" ]; then
    ...
    BACKUP_DIR="$HOME/.open-agent/config.backup.$(date +%Y%m%d_%H%M%S)"
...
echo ""
echo -e "${YELLOW}1. Install Open Agent:${NC}"
echo -e "   ${GREEN}pipx install git+https://github.com/MiniMax-AI/open-agent.git${NC}"
echo ""
...
echo ""
echo -e "${YELLOW}3. Start using Open Agent:${NC}"
echo -e "   ${GREEN}open-agent${NC}                              # Use current directory"
echo -e "   ${GREEN}open-agent --workspace /path/to/project${NC} # Specify workspace"
echo -e "   ${GREEN}open-agent --help${NC}                      # Show help"
echo ""
